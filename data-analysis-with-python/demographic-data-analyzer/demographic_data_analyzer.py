...
def calculate_demographic_data(print_data=True):
    # Read data from file
    csv_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'adult.data.csv')
    ...
    country_salary = df.groupby('native-country')['salary'].apply(lambda s: (s == '>50K').mean() * 100)
